...
def print_gpu_memory_use(gpu_id: int, title: str) -> None:
    ...
    paddle_reserved = paddle.device.cuda.max_memory_reserved(gpu_id)
    paddle_allocated = paddle.device.cuda.max_memory_allocated(gpu_id)
    ...
    print(
        ...
        f"\n\tPaddle max memory Reserved: {paddle_reserved}",
        f"\n\tPaddle max memory Allocated: {paddle_allocated}",
    )
