...
from paddleformers.transformers.tokenizer_utils_base import BatchEncoding

from .qwen2_5_vl_utils.downloader import (
    COMMUNITY_MODEL_PREFIX,
    get_path_from_url_with_filelock,
    resolve_cache_dir,
)
from .qwen2_5_vl_utils.log import logger
