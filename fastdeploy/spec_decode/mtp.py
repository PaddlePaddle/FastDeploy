...
class MTPProposer(Proposer):
    ...
    def dummy_prefill_inputs(self, num_tokens: int, batch_size: int, expected_decode_len: int):
        ...
        self.model_inputs["seq_lens_this_time"] = self.tmp_seq_lens_this_time
    ...
    def insert_prefill_inputs(self, req_dicts: List[Request], num_running_requests):
        ...
        for i in range(req_len):
            ...
            if req_dicts[i].disaggregate_info is not None and req_dicts[i].disaggregate_info["role"] == "decode":
                ...
                self.tmp_seq_lens_this_time[idx : idx + 1] = prefill_token_num
        ...
        self.model_inputs["seq_lens_this_time"] = copy.deepcopy(self.tmp_seq_lens_this_time[:num_running_requests])
