...
class InputBatch:
    ...
    def init_share_inputs(self):
        ...
        self.min_dec_len = paddle.full([max_num_seqs], self.model_config.min_length, dtype="int64")
        self.max_dec_len = paddle.full([max_num_seqs], self.model_config.max_model_len, dtype="int64")
        ...
        self.step_seq_lens_encoder = paddle.full([max_num_seqs], 0, dtype="int32")
        self.step_seq_lens_decoder = paddle.full([max_num_seqs], 0, dtype="int32")
