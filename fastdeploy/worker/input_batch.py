...
class InputBatch:
    ...
    def init_share_inputs(self):
        ...
        self.seq_lens_kv = paddle.full(shape=[max_num_seqs + 8, 1], fill_value=0, dtype="int32")
...
class ProposerInputBatch(InputBatch):
    ...
    def init_share_inputs(self):
        ...
        self.seq_lens_kv = paddle.full(shape=[self.scheduler_config.max_num_seqs + 8, 1], fill_value=0, dtype="int32")
