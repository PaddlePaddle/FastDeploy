...
class GPUModelRunner(ModelRunnerBase):
    ...
    def initialize_forward_meta(self, is_dummy_or_profile_run=False):
        ...
        haha = self.share_inputs["seq_lens_this_time"].shape[0]
        self.forward_meta = ForwardMeta(
            ...
            seq_lens_encoder=self.share_inputs["seq_lens_encoder"][:haha],
            seq_lens_decoder=self.share_inputs["seq_lens_decoder"][:haha],
            seq_lens_this_time=self.share_inputs["seq_lens_this_time"],
            batch_id_per_token=self.share_inputs["batch_id_per_token"],
            cu_seqlens_q=self.share_inputs["cu_seqlens_q"],
            cu_seqlens_k=self.share_inputs["cu_seqlens_k"],
            block_tables=self.share_inputs["block_tables"][:haha],
