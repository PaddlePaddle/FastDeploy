...
class GPUModelRunner(ModelRunnerBase):
    def __init__(
        ...
        self.enable_mm = self.multi_modal_config.enable_mm
        self.rank = rank
    ...
    def update_share_input_block_num(self, num_gpu_blocks: int) -> None:
        ...
        # Reset free list
        free_list = list(
            range(self.num_gpu_blocks - 1, int(self.num_gpu_blocks * self.cache_config.kv_cache_ratio) - 1, -1)
        )
        self.free_list_len = len(free_list)
    ...
    def prepare_rope3d(self, position_ids: paddle.Tensor, max_len: int) -> paddle.Tensor:
        ...
        rope_emb = get_rope_3d(
            ...
            base=self.model_config.rope_theta,
            max_position=self.scheduler_config.max_model_len,
