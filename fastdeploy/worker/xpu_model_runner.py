...
class XPUModelRunner(ModelRunnerBase):
    ...
    def _dummy_prefill_inputs(self, num_tokens: int, batch_size: int):
        ...
        full_length = min(num_tokens // batch_size, self.scheduler_config.max_model_len - 10)
    ...
    def execute_model(
        ...
        step_paddle(self.share_inputs, self.cache_config.block_size, self.cache_config.enc_dec_block_num)
    ...
    def cal_theortical_kvcache(self):
        ...
        required_memory = (
            byte_of_dtype
            * 2
            * (self.cache_config.block_size * hidden_dim)  # k + v
