...
class GraphOptimizationConfig:
    ...
    def init_with_cudagraph_size(self, max_num_seqs: int = 0) -> None:
        """
...
class FDConfig:
    ...
    def __init__(
        ...
        self.graph_opt_config.init_with_cudagraph_size(max_num_seqs=self.parallel_config.max_num_seqs)
