...
class GraphOptimizationConfig:
    ...
    def init_with_cudagraph_size(self, max_capture_size: int = 0) -> None:
        """
...
class FDConfig:
    ...
    def __init__(
        ...
        if self.graph_opt_config.cudagraph_only_prefill:
            self.graph_opt_config.init_with_cudagraph_size(max_capture_size=512)
        else:
            self.graph_opt_config.init_with_cudagraph_size(max_capture_size=self.parallel_config.max_num_seqs)
