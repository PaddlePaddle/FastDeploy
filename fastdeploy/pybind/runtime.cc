...
void BindRuntime(pybind11::module& m) {
  pybind11::class_<RuntimeOption>(m, "RuntimeOption")
      ...
      .def("enable_ort_fp16", &RuntimeOption::EnableOrtFP16)
      .def("disable_ort_fp16", &RuntimeOption::DisableOrtFP16)
      ...
      .def_readwrite("ort_enable_fp16", &RuntimeOption::ort_enable_fp16)
