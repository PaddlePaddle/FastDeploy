...
class ExpertService:
    ...
    def __init__(self, cfg, local_data_parallel_id):
        ...
        self.cfg.device_config.local_device_ids = self.cfg.device_config.device_ids.split(",")[start_pos:end_pos]
        ...
        address = (cfg.scheduler_config.master_ip, cfg.scheduler_config.engine_worker_queue_port)
