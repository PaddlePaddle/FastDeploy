...
MiniMax-M1 model implementation for FastDeploy inference.
Hybrid architecture with 70 linear attention layers and 10 full attention layers.
MoE configuration: 32 experts with top-2 routing per token.
"""
...
class MiniMaxM1MoE(nn.Layer):
    """MoE layer with low-bit quantization support."""
...
class MiniMaxM1DecoderLayer(nn.Layer):
    """Decoder layer with hybrid attention dispatch."""
