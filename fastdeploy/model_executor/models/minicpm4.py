"""MiniCPM4/4.1 model implementation for FastDeploy.
...
class MiniCPM4DecoderLayer(nn.Layer):
    """Single decoder layer with μP (Maximal Update Parametrization) residual scaling."""
    ...
    def _get_tensor_parallel_mappings(cls, config: ModelConfig, is_split=True):
        ...
        def get_tensor_parallel_split_mappings(num_layers):
            ...
            if config.fuse_attention_qkv:
                ...
                # MiniCPM4 uses no QKV bias — only weight splits needed
