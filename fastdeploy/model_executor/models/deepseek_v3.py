        ...
        if forward_meta.max_len_tensor_cpu[1]:
            ...
            for i in range(bsz):
                if forward_meta.seq_lens_encoder[i] > 0:
                    batch_start_k = forward_meta.cu_seqlens_k[i]
                    batch_end_k = forward_meta.cu_seqlens_k[i + 1]
                    ks[batch_start_k:batch_end_k] = forward_meta.cu_seqlens_k[i]
                    ke[batch_start_k:batch_end_k] = paddle.arange(batch_start_k, batch_end_k, dtype=paddle.int32) + 1
