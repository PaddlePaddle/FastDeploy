...
class FlowMatchEulerDiscreteScheduler:
    ...
    def set_timesteps(
        ...
        # 均匀间隔的 sigma 值 (Linearly spaced, matching HF: 1→1/N_train, then append 0)
        sigmas = np.linspace(1.0, 1.0 / self.num_train_timesteps, num_inference_steps, dtype=np.float64)
