...
@dataclass
class TokenSparseAttnV2Metadata(AttentionMetadata):
    """
    TokenSparseAttnV2Metadata
    """
...
class TokenSparseAttnV2Backend(AttentionBackend):
    """
    FlashAttentionBackend backend implementation
    """

    __infer_dynamic_dims_fields__ = ["attention_metadata"]
    attention_metadata: TokenSparseAttnV2Metadata
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.attention_metadata: TokenSparseAttnV2Metadata = None
