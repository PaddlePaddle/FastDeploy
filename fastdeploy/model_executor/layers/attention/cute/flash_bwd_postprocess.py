...
class FlashAttentionBackwardPostprocess:
    def __init__(
        ...
        self.dtype = dtype
        self.tile_m = tile_m
        assert arch in [80, 90, 100], "Only Ampere (80), Hopper (90), and Blackwell (100) are supported"
        self.arch = arch
    ...
    def __call__(
        ...
        mdQaccum, mdQ = [
            cute.make_tensor(t.iterator, cute.make_layout(t.shape, stride=new_stride(t))) for t in (mdQaccum, mdQ)
        ]
