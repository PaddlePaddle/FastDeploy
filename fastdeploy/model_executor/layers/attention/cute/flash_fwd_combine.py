...
class FlashAttentionForwardCombine:
    ...
    def _setup_attributes(self):
        ...
        m_block_smem = (
            ...
            if self.m_block_size % 128 == 0
                ...
                else (32 if self.m_block_size % 32 == 0 else (16 if self.m_block_size % 16 == 0 else 8))
            )
        )
        ...
        self.smem_layout_lse = cute.tile_to_shape(smem_layout_atom_lse, (self.max_splits, self.m_block_size), (0, 1))
    ...
    def __call__(
        ...
        mO_partial, mO = [
            cute.make_tensor(t.iterator, cute.make_layout(t.shape, stride=new_stride(t))) for t in (mO_partial, mO)
        ]
