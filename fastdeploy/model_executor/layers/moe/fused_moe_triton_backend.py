...
class BlockWiseFP8MoEMethod(QuantMethodBase):
    ...
    def process_weights_after_loading(self, layer):
        ...
        weight_shape = self.ffn1_weight_shape if weight_type == "gate_up" else self.ffn2_weight_shape
        weight_dtype = paddle.float8_e4m3fn
        # scale
        scale_name = self.added_scale_attrs[weight_id_map[weight_type]]
        scale_shape = self.ffn1_scale_shape if weight_type == "gate_up" else self.ffn2_scale_shape
        scale_dtype = "float32"
