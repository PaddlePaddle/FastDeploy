...
def python_op_fused_moe_kernel_paddle(
    ...
    if not fastdeploy.envs.FD_USE_PHI_FP8_QUANT:
        ...
        x_q, x_scale = paddle.incubate.nn.functional.fp8_quant_blockwise(
            x, using_pow2_scale=fastdeploy.envs.TI_CONSIST_FP8_QUANT_WITH_POW2SCALE, output_scale_transpose=False
        )
    ...
    if not fastdeploy.envs.FD_USE_PHI_FP8_QUANT:
        ...
        x_q, x_scale = paddle.incubate.nn.functional.fp8_quant_blockwise(
            intermediate_cache2,
            using_pow2_scale=fastdeploy.envs.TI_CONSIST_FP8_QUANT_WITH_POW2SCALE,
