...
#include "fastdeploy/vision/posedetpipeline/pptinypose_pipeline/pptinypose_pipeline.h"

namespace fastdeploy {
namespace application {
namespace posedetpipeline {
PPTinyPosePipeline::PPTinyPosePipeline(
...
bool PPTinyPosePipeline::Detect(
...
bool PPTinyPosePipeline::KeypointDetect(
...
bool PPTinyPosePipeline::Predict(
    cv::Mat* img, fastdeploy::vision::KeyPointDetectionResult* result) {
  result->Clear();
