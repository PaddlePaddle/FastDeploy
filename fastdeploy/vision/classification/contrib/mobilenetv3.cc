...
namespace fastdeploy {
    namespace vision {
        namespace classification {
            ...
            MobileNetV3::MobileNetV3(const std::string& model_file,
            ...
            bool MobileNetV3::Preprocess(Mat* mat, FDTensor* output) {
                ...
                if (mat->Height() != size[0] || mat->Width() != size[1]) {
                    ...
                    ResizeByShort::Run(mat, 256, interp);
            ...
            bool MobileNetV3::Postprocess(FDTensor& infer_result,
            ...
            bool MobileNetV3::Predict(cv::Mat* im, ClassifyResult* result, int topk) {
