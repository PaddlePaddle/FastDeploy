...
void TablePreprocessor::OcrTableResizeImage(FDMat* mat, int batch_idx) {
...
bool TablePreprocessor::Run(std::vector<FDMat>* images,
                            std::vector<FDTensor>* outputs, size_t start_index,
