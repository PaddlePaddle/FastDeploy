...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # enable lock-free kv cache block scheduler v2 (message queue based, overrides V1)
    "ENABLE_V2_KVCACHE_SCHEDULER": lambda: int(os.getenv("ENABLE_V2_KVCACHE_SCHEDULER", "0")),
