...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "FD_MOBA_MLP_WEIGHT_PATH":
    lambda: os.getenv("FD_MOBA_MLP_WEIGHT_PATH", None),

    "FD_MOBA_ENCODER_TOP_K_LEFT":
    lambda: os.getenv("FD_MOBA_ENCODER_TOP_K_LEFT", 0),

    "FD_MOBA_ENCODER_TOP_K_RIGHT":
    lambda: os.getenv("FD_MOBA_ENCODER_TOP_K_RIGHT", 0),

    "FD_MOBA_DECODER_TOP_K_LEFT":
    lambda: os.getenv("FD_MOBA_DECODER_TOP_K_LEFT", 0),

    "FD_MOBA_DECODER_TOP_K_RIGHT":
    lambda: os.getenv("FD_MOBA_DECODER_TOP_K_RIGHT", 0),

    "FD_MOBA_USE_ENCODER_SEQ_LIMIT":
    lambda: os.getenv("FD_MOBA_USE_ENCODER_SEQ_LIMIT", 0),

    "FD_MOBA_USE_DECODER_SEQ_LIMIT":
    lambda: os.getenv("FD_MOBA_USE_DECODER_SEQ_LIMIT", 0),

    "FD_MOBA_BLOCK_SIZE":
    lambda: os.getenv("FD_MOBA_BLOCK_SIZE", 128),

    "FD_MOBA_MAX_SEQ_LENGTH":
    lambda: os.getenv("FD_MOBA_MAX_SEQ_LENGTH", 131072),
