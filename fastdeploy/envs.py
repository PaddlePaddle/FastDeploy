...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Due to the dynamic 2-bit quantization cache, a portion of the BF16 precision will be retained, which is the reserved token length
    "FD_DYNAMIC_QUANT_CACHE_C16_LEN": lambda: int(os.getenv("FD_DYNAMIC_QUANT_CACHE_C16_LEN", "128")),
}
