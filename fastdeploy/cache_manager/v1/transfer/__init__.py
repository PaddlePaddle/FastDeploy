"""
Transfer module for cross-node and cross-process KV cache transfer.

This module provides transfer mechanisms for KV cache data movement
in PD (Pipeline-Data) separation deployments.

Factory functions:
    - create_transfer_connector: Create a TransferConnector instance based on config
"""
