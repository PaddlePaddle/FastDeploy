...
class LLM:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.default_sampling_params = SamplingParams(max_tokens=self.llm_engine.cfg.scheduler_config.max_model_len)

        self.llm_engine.start()

        self.mutex = threading.Lock()
        self.req_output = dict()
        self.master_node_ip = self.llm_engine.cfg.scheduler_config.master_ip
