...
- 🔥 **2022.11.23：Release FastDeploy [release v0.8.0](https://github.com/PaddlePaddle/FastDeploy/tree/release/0.8.0)** <br>
  ...
  - **📱 Mobile and Edge Device Deployment: support more CV model**
    - Support Android image classification, target detection, semantic segmentation, OCR, face detection APK projects and examples.
        ...
        |<font size=2>[Scan the code or click on the link to install and try out](https://bj.bcebos.com/fastdeploy/release/android/FastDeploy-MobileNetV1.apk)</font>|<font size=2>[Scan the code or click on the link to install try out](https://bj.bcebos.com/fastdeploy/release/android/FastDeploy-PicoDet.apk)</font>| <font size=2>[Scan the code or click on the link to install and try out](https://bj.bcebos.com/fastdeploy/release/android/FastDeploy-Portrait-HumanSegV2-Lite.apk)</font>| <font size=2> [Scan the code or click on the link to install and try out](https://bj.bcebos.com/fastdeploy/release/android/FastDeploy-PP-OCRv2.apk)</font>|<font size=2> [Scan the code or click on the link to install and try out](https://bj.bcebos.com/fastdeploy/release/android/FastDeploy-SCRFD.apk)</font>|     
