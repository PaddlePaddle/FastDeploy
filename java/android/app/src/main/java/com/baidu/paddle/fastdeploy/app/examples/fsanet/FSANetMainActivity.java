...
public class FSANetMainActivity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    private static final String TAG = FSANetMainActivity.class.getSimpleName();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_settings:
                startActivity(new Intent(FSANetMainActivity.this, FSANetSettingsActivity.class));
                break;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (shutterBitmap != null && !shutterBitmap.isRecycled()) {
                            ...
                            new AlertDialog.Builder(FSANetMainActivity.this)
...
//                ARGB8888ImageBitmap, FSANetSettingsActivity.scoreThreshold, 0.4f);
...
//        resultNum = 1.0f;
    ...
    public void initSettings() {
        ...
        editor.clear();
        editor.commit();
        FSANetSettingsActivity.resetSettings();
    }

    public void checkAndUpdateSettings() {
//        if (FSANetSettingsActivity.checkAndUpdateSettings(this)) {
//            String realModelDir = getCacheDir() + "/" + FSANetSettingsActivity.modelDir;
//            Utils.copyDirectoryFromAssets(this, FSANetSettingsActivity.modelDir, realModelDir);
//
//            String modelFile = realModelDir + "/" + "model.pdmodel";
//            String paramsFile = realModelDir + "/" + "model.pdiparams";
//            RuntimeOption option = new RuntimeOption();
//            option.setCpuThreadNum(FSANetSettingsActivity.cpuThreadNum);
//            option.setLitePowerMode(FSANetSettingsActivity.cpuPowerMode);
//            if (Boolean.parseBoolean(FSANetSettingsActivity.enableLiteFp16)) {
            ...
            new AlertDialog.Builder(FSANetMainActivity.this)
                    ...
                    .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            FSANetMainActivity.this.finish();
                        }
                    }).show();
        }
    }
