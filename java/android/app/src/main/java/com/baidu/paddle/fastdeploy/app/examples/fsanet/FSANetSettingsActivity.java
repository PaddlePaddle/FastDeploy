...
public class FSANetSettingsActivity extends AppCompatPreferenceActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = FSANetSettingsActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.fsanet_settings);
        ...
        preInstalledModelDirs.add(getString(R.string.FSANET_MODEL_DIR_DEFAULT));
        preInstalledCPUThreadNums.add(getString(R.string.CPU_THREAD_NUM_DEFAULT));
        preInstalledCPUPowerModes.add(getString(R.string.CPU_POWER_MODE_DEFAULT));
        preInstalledScoreThresholds.add(getString(R.string.SCORE_THRESHOLD_FSANET));
    ...
    private void reloadSettingsAndUpdateUI() {
        ...
        String selected_model_dir = sharedPreferences.getString(getString(R.string.CHOOSE_PRE_INSTALLED_MODEL_KEY),
                getString(R.string.FSANET_MODEL_DIR_DEFAULT));
        ...
        String score_threshold = sharedPreferences.getString(getString(R.string.SCORE_THRESHOLD_KEY),
                getString(R.string.SCORE_THRESHOLD_FSANET));
    ...
    static boolean checkAndUpdateSettings(Context ctx) {
        ...
        String model_dir = sharedPreferences.getString(ctx.getString(R.string.MODEL_DIR_KEY),
                ctx.getString(R.string.FSANET_MODEL_DIR_DEFAULT));
        ...
        String score_threshold = sharedPreferences.getString(ctx.getString(R.string.SCORE_THRESHOLD_KEY),
                ctx.getString(R.string.SCORE_THRESHOLD_FSANET));
