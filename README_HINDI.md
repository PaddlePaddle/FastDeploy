[English](README_EN.md) | [简体中文](README_CN.md)| हिंदी | [日本語](README_JPN.md)
...
```python
# GPU/TensorRTतैनाती संदर्भ  examples/vision/detection/paddledetection/python
import cv2
...
- C++ प्रीकंपाइल्ड लाइब्रेरी डाउनलोड दस्तावेज़ देखें (docs/cn/build_and_install/download_prebuilt_libraries.md)文档  
...
प्रतीक विवरण: (1)  ✅: पहले से समर्थित; (2) ❔: प्रगति पर; (3) N/A: समर्थित नहीं; <br>
