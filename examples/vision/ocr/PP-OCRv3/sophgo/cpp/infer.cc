...
void InitAndInfer(const std::string& det_model_dir, const std::string& rec_label_file, const std::string& image_file, const fastdeploy::RuntimeOption& option) {
  auto det_model_file = det_model_dir + sep + "ch_PP-OCRv3_det_1684x_f32.bmodel";
  auto det_params_file = det_model_dir + sep + "";

  auto cls_model_file = det_model_dir + sep + "ch_ppocr_mobile_v2.0_cls_1684x_f32.bmodel";
  auto cls_params_file = det_model_dir + sep + "";

  auto rec_model_file = det_model_dir + sep + "ch_PP-OCRv3_rec_1684x_f32.bmodel";
  ...
  auto rec_model = fastdeploy::vision::ocr::Recognizer(rec_model_file, rec_params_file, rec_label_file, rec_option, format);
