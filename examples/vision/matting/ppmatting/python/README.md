...
```python
fd.vision.matting.PPMatting(model_dir, params_file, config_file, runtime_option=None, model_format=Frontend.PADDLE)
```

PPMatting模型加载和初始化，其中model_dir, params_file以及config_file为训练模型导出的Paddle inference文件，具体请参考其文档说明[模型导出](https://github.com/PaddlePaddle/PaddleSeg/tree/release/2.6/Matting)
