...
python paddle_infer_shape.py --model_dir PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer/ \
                             ...
                             --save_dir PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer \
                             --input_shape_dict="{'x':[1,3,512,1024]}"

# 静态图转ONNX模型，注意，这里的save_file请和压缩包名对齐
paddle2onnx --model_dir PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer \
            --model_filename model.pdmodel \
            --params_filename model.pdiparams \
            --save_file PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer/PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer.onnx \
...
python /PathToFastDeploy/tools/rknpu2/export.py \
        --config_path tools/rknpu2/config/PP_LiteSeg_B_STDC2_cityscapes_without_argmax_infer.yaml \
