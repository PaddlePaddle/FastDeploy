...
本目录下提供的 `infer.cc`，可以帮助用户快速完成 Yolov5 量化模型在 RK1126 上的部署推理加速。
...
## 在 RK1126 上部署量化后的 Yolov5 检测模型
请按照以下步骤完成在 RK1126 上部署 Yolov5 量化模型：
...
5. 基于 adb 工具部署 Yolov5 分类模型到 Rockchip RV1126，可使用如下命令：
```bash
# 进入 install 目录
