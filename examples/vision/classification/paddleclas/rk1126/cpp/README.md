...
## 部署准备
### FastDeploy 交叉编译环境准备
- 1. 软硬件环境满足要求，以及交叉编译环境的准备，参考[FastDeploy 交叉编译环境准备](../../../../../../docs/cn/build_and_install/TIMVX.md#交叉编译环境搭建)  
...
1. 交叉编译编译 FastDeploy 库，具体请参考[交叉编译 FastDeploy](../../../../../../docs/cn/build_and_install/TIMVX.md#基于-paddlelite-的-fastdeploy-交叉编译库编译)
