...
| ```lm_head_dtype```       | `str`      | Specify the data type of the lm_head layer. If `config.json` does not contain this field, the dtype specified by this parameter should be used. |
