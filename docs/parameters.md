...
| ```use_cudagraph```                | `bool`      | __[DEPRECATED]__ CUDAGraph is enabled by default since version 2.2. It is recommended to read [graph_optimization.md](./features/graph_optimization.md) carefully before opening. |
