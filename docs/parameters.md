...
| ```max_encoder_cache```   | `int` | Maximum number of tokens in the encoder cache (use 0 to disable), default: -1. PaddleOCR-VL on Metax GPU auto-enables this to `max_num_batched_tokens` when unspecified. |
