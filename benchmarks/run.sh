...
data_path=/root/paddlejob/workspace/env_run/output/changwenbin/Sparse_GQA/baidu/paddle_internal/FastDeploy/benchmarks/16K_batch_data
yaml_path=/root/paddlejob/workspace/env_run/output/changwenbin/Sparse_GQA/baidu/paddle_internal/FastDeploy/benchmarks/yaml/request_yaml/eb-128k.yaml
...
server_ip=0.0.0.0
python /root/paddlejob/workspace/env_run/output/changwenbin/Sparse_GQA/baidu/paddle_internal/FastDeploy/benchmarks/benchmark_serving.py \
    --backend openai-chat \
    --model default \
    --endpoint /v1/chat/completions \
    --host ${server_ip} \
    ...
    --max-concurrency 1 \
    --drop-ratio 0.2 \
    --save-result --debug > EB5index16K 2>&1
