...
if(PADDLEINFERENCE_DIRECTORY)
  ...
  if(WIN32)
    if (WITH_GPU)
      set(PADDLEINFERENCE_FILE "paddle_inference-win-x64-gpu-trt8.5.2.2-mkl-avx-0.0.0-20230410.zip")
    else()
      set(PADDLEINFERENCE_FILE "paddle_inference-win-x64-mkl-avx-0.0.0-20230410.zip")
    endif()
