...
ELSEIF(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  IF(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "aarch64")
    set(OPENSSL_FILENAME "openssl-OpenSSL_1_1_1k")
  ENDIF()
...
if(THIRD_PARTY_PATH)
        ...
        SET(OPENSSL_ROOT_DIR ${FASTDEPLOY_INSTALL_DIR}/installed_fastdeploy/cmake/openssl-OpenSSL_1_1_1k/install-${CMAKE_SYSTEM_PROCESSOR})
endif()
