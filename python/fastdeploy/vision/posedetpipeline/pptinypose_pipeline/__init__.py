...
from .... import FastDeployModel
from .... import c_lib_wrap as C


class PPTinyPosePipeline(FastDeployModel):
    def __init__(self, det_model=None, pptinypose_model=None):
        ...
        self.pipeline = C.vision.posedetpipeline.PPTinyPosePipeline(
            det_model._model, pptinypose_model._model)

    def predict(self, input_image):
        return self.pipeline.predict(input_image)
