...
def vis_detection(im_data,
    ...
    :return: (numpy.ndarray) image with visulized results
    """
...
def vis_face_alignment(im_data, face_align_result, line_size=1):
    """Show the visulized results for face alignment models
...
def vis_segmentation(im_data, seg_result, weight=0.5):
    """Show the visulized results for segmentation models
