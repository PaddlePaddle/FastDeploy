...
class PPMSVSR(FastDeployModel):
    def __init__(self,
        ...
        self._model = C.vision.gan.PPMSVSR(model_file, params_file,
...
class EDVR(PPMSVSR):
    def __init__(self,
        ...
        self._model = C.vision.gan.EDVR(model_file, params_file,
                                        self._runtime_option, model_format)
...
class BasicVSR(PPMSVSR):
    def __init__(self,
        ...
        self._model = C.vision.gan.BasicVSR(model_file, params_file,
                                            self._runtime_option, model_format)
