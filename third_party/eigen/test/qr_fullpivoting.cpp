...
void qr() {
  STATIC_CHECK((
      internal::is_same<typename FullPivHouseholderQR<MatrixType>::StorageIndex,
                        int>::value));
  ...
  Index rows = Rows == Dynamic ? internal::random<Index>(min_size, max_size)
                               : Rows,
        cols = Cols == Dynamic ? internal::random<Index>(min_size, max_size)
                               : Cols,
        cols2 = Cols == Dynamic ? internal::random<Index>(min_size, max_size)
                                : Cols,
