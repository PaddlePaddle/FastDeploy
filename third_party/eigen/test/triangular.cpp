...
void triangular_deprecated(const MatrixType& m) {
  ...
  m3.template triangularView<Eigen::Upper>().swap(
      m4.template triangularView<Eigen::Upper>());
  VERIFY_IS_APPROX(m1, m3);
  VERIFY_IS_APPROX(m2, m4);
  // deprecated method:
  m1.template triangularView<Eigen::Lower>().swap(m4);
  // use this method instead:
  m3.template triangularView<Eigen::Lower>().swap(
...
void triangular_square(const MatrixType& m) {
  ...
  m1.setOnes();
  m2.setZero();
  m2.template triangularView<Upper>().swap(
      m1.template triangularView<Eigen::Upper>());
  m3.setZero();
  m3.template triangularView<Upper>().setOnes();
  VERIFY_IS_APPROX(m2, m3);
  VERIFY_RAISES_STATIC_ASSERT(m1.template triangularView<Eigen::Lower>().swap(
      m2.template triangularView<Eigen::Upper>()));
