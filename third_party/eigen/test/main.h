...
// / "max", only partially resolves the issue
// This is because other HIP header files also define "isnan" / "isinf" /
// "isfinite" functions, which are needed in other
// headers.
//
...
/** Creates a random Partial Isometry matrix of given rank.
  *
  * A partial isometry is a matrix all of whose singular values are either 0 or
 * 1.
