...
void lu_non_invertible() {
  STATIC_CHECK((internal::is_same<typename FullPivLU<MatrixType>::StorageIndex,
                                  int>::value));
...
void lu_partial_piv(Index size = MatrixType::ColsAtCompileTime) {
  ...
  */
  ...
  STATIC_CHECK(
      (internal::is_same<typename PartialPivLU<MatrixType>::StorageIndex,
                         int>::value));
