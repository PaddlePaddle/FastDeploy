...
// precision of x87 registers.
// It seems that it is not needed anymore, but let's keep it here, just in
// case...
...
Matrix<Scalar, Dim, (1 << Dim)> boxGetCorners(
    const Matrix<Scalar, Dim, 1>& min_, const Matrix<Scalar, Dim, 1>& max_) {
