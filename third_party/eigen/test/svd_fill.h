...
void svd_fill_random(MatrixType &m, int Option = 0) {
  ...
  bool unit_uv = internal::random<int>(0, 10) <
                 (dup ? 7 : 3);  // if we duplicate some diagonal entries, then
                                 // increase the chance to preserve them using
                                 // unitary U and V factors
