...
class PolynomialSolverBase {
 ...
 public:
   ...
   * with the _Scalar template parameter of the PolynomialSolver class as the
   * default value.
   * If no real root is found the boolean hasArealRoot is set to false and the
   * real part of
   ...
   * \param[in] absImaginaryThreshold : threshold on the absolute imaginary part
   * to decide
...
/** \ingroup Polynomials_Module
  ...
  *
  * \param _Scalar the scalar type, i.e., the type of the polynomial
 * coefficients
 ...
 * matrix of
  ...
  * This supposes that the complex moduli of the roots are all distinct: e.g.
 * there should
  * be no multiple roots or conjugate roots for instance.
  * With 32bit (float) floating types this problem shows up frequently.
  * However, almost always, correct accuracy is reached even in these cases for
 * 64bit
