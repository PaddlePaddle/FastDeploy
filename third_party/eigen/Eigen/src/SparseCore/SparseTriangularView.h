 ...
 * type TriangularViewImpl cannot be instantiated.
  * It extends class TriangularView with additional methods which are available
 * for sparse expressions only.
  *
 ...
 public:
  ...
  class InnerIterator : public EvalIterator {
   ...
   public:
    ...
    //       inline Index col() const { return (ArgType::Flags&RowMajorBit ?
