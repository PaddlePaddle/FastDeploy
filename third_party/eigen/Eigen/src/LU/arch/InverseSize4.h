...
// (deprecated) \src\LU\Inverse_SSE.h
...
struct compute_inverse_size4<Architecture::Target, float, MatrixType,
  ...
  static void run(const MatrixType &mat, ResultType &result) {
    ...
    const Packet4f p4f_sign_PNNP = preinterpret<Packet4f, Packet4i>(
        pgather<int, Packet4i>(bits, static_cast<Eigen::Index>(1)));
...
struct compute_inverse_size4<Architecture::Target, double, MatrixType,
  ...
  static void run(const MatrixType &mat, ResultType &result) {
    ...
    const Packet2d _Sign_NP = preinterpret<Packet2d, Packet4i>(
        pgather<int, Packet4i>(bits1, static_cast<Eigen::Index>(1)));
    const Packet2d _Sign_PN = preinterpret<Packet2d, Packet4i>(
        pgather<int, Packet4i>(bits2, static_cast<Eigen::Index>(1)));
    d1 = pxor(rd, _Sign_PN);
    d2 = pxor(rd, _Sign_NP);
