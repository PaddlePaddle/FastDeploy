 ...
 * generic case `A.colwise().foo()`
  * where `foo` is any method of `VectorwiseOp`. This expression is equivalent
 * to applying `foo()` to each
 ...
 * as they
  * return STL-compatible begin/end iterators to the rows or columns of the
 * nested expression.
