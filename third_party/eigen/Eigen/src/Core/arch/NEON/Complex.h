...
EIGEN_STRONG_INLINE Packet2cf pxor<Packet2cf>(const Packet2cf& a,
                                              const Packet2cf& b);
template <>
EIGEN_STRONG_INLINE Packet2cf paddsub<Packet2cf>(const Packet2cf& a,
                                                 const Packet2cf& b) {
...
struct conj_helper<Packet1cf, Packet1cf, false, true> {
  EIGEN_STRONG_INLINE Packet1cf pmadd(const Packet1cf& x, const Packet1cf& y,
                                      const Packet1cf& c) const {
    return padd(pmul(x, y), c);
  }

  EIGEN_STRONG_INLINE Packet1cf pmul(const Packet1cf& a,
                                     const Packet1cf& b) const {
