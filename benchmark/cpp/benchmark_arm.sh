...
# PaddleDetection (NO NMS for Paddle Lite to compare with MNN/TNN/NCNN)
...
./benchmark_ppyolov7 --model yolov7_l_300e_coco_no_nms --image 000000014439.jpg --config_path $CONFIG_PATH --no_nms && sleep_seconds 60
./benchmark_ppyoloe --model ppyoloe_crn_l_300e_coco_no_nms --image 000000014439.jpg --config_path $CONFIG_PATH --no_nms && sleep_seconds 60
