...
benchmark_arm_partial() {
  ...
  ./benchmark_ppseg --model Deeplabv3_ResNet101_OS8_cityscapes_with_argmax_infer --image cityscapes_demo.png --config_path $config_path && sleep_seconds
  ./benchmark_ppseg --model SegFormer_B0-cityscapes-with-argmax --image cityscapes_demo.png --config_path $config_path && sleep_seconds
...
benchmark_arm_all() {
  ...
  ./benchmark_ppyolov7 --model yolov7_l_300e_coco_no_nms --image 000000014439.jpg --config_path $config_path --no_nms && sleep_seconds
  ./benchmark_ppyolov8 --model yolov8_s_500e_coco_no_nms --image 000000014439.jpg --config_path $config_path --no_nms && sleep_seconds
  ./benchmark_ppyolox --model yolox_s_300e_coco_no_nms --image 000000014439.jpg --config_path $config_path --no_nms && sleep_seconds
  ./benchmark_ppyoloe --model ppyoloe_crn_l_300e_coco_no_nms --image 000000014439.jpg --config_path $config_path --no_nms && sleep_seconds
  ...
  ./benchmark_ppseg --model Deeplabv3_ResNet101_OS8_cityscapes_with_argmax_infer --image cityscapes_demo.png --config_path $config_path && sleep_seconds
  ./benchmark_ppseg --model SegFormer_B0-cityscapes-with-argmax --image cityscapes_demo.png --config_path $config_path && sleep_seconds
  ./benchmark_ppmatting --model PP-Matting-512 --image matting_input.jpg --config_path $config_path && sleep_seconds
  ./benchmark_ppmatting --model PPHumanMatting --image matting_input.jpg --config_path $config_path && sleep_seconds
  ./benchmark_ppmatting --model PPModnet_MobileNetV2 --image matting_input.jpg --config_path $config_path && sleep_seconds

  # num: 31
}

if [ "$profile_tag" = "all" ]; then
  benchmark_arm_all
else
  benchmark_arm_partial
fi
...
# ./benchmark_arm.sh config.arm.lite.txt all
# ./benchmark_arm.sh config.arm.mnn.txt all
# ./benchmark_arm.sh config.arm.tnn.txt all
# ./benchmark_arm.sh config.arm.ncnn.txt all
