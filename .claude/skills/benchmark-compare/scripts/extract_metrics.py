...
def compute_comparison(fd_metrics, sg_metrics):
    ...
    # 吞吐类指标：越高越好
    higher_is_better = {
        "total_token_throughput", "output_token_throughput",
        "request_throughput", "mean_decode", "median_decode",
        "p80_decode", "p95_decode", "p99_decode",
    }
...
def main():
    ...
    key_metrics = [
        "total_token_throughput", "output_token_throughput",
        "mean_ttft", "mean_tpot", "mean_itl", "mean_e2el",
        "mean_decode", "benchmark_duration",
    ]
    print("\n========== 核心指标摘要 ==========")
