...
gemm_case = [
    ...
    [7168, 7168, 6, 13056, 128],  # num_max_dispatch_tokens_per_rank=204
    [7168, 3584, 6, 13056, 128],  # num_max_dispatch_tokens_per_rank=204
    [7168, 7168, 6, 16384, 128],  # num_max_dispatch_tokens_per_rank=256
    [7168, 3584, 6, 16384, 128],  # num_max_dispatch_tokens_per_rank=256
    [7168, 7168, 6, 19968, 128],  # num_max_dispatch_tokens_per_rank=312
    [7168, 3584, 6, 19968, 128],  # num_max_dispatch_tokens_per_rank=312
