...
PYBIND11_MODULE(fastdeploy_ops, m) {
  ...
  m.def("draft_model_preprocess",
        ...
        py::arg("accept_num"),
        py::arg("target_model_seq_lens_encoder"),
        py::arg("target_model_seq_lens_decoder"),
        py::arg("target_model_step_idx"),
        py::arg("target_model_stop_flags"),
        py::arg("max_dec_len"),
        py::arg("target_model_draft_tokens"),
        py::arg("num_model_step"),
        py::arg("is_splitwise_prefill"),
