...
AdjustBatchKernel(const paddle::Tensor &x,           // [token_num, dim_embed]
    ...
    baidu::xpu::api::VectorParam<int32_t> decoder_seqs_lods_vp{
        ...
        dec_batch + 1, const_cast<int32_t *>(decoder_seq_lod.data<int32_t>())};
    ...
    int r = baidu::xpu::api::plugin::eb_adjust_batch<XPUType, XPUType>(
        ...
        encoder_seqs_lods_vp, decoder_seqs_lods_vp,
...
AdjustBatch(const paddle::Tensor &x,           // [token_num, dim_embed]
    ...
    return func(x, cum_offsets, encoder_seq_lod, decoder_seq_lod, encoder_batch_idx,
                decoder_batch_idx, encoder_seq_lod_cpu, decoder_seq_lod_cpu, 
                encoder_batch_idx_cpu, decoder_batch_idx_cpu, len_info_cpu,
...
PD_BUILD_OP(adjust_batch)
    .Inputs({"x", "cum_offsets", "encoder_seq_lod", "decoder_seq_lod", "encoder_batch_idx",
             "decoder_batch_idx", "encoder_seq_lod_cpu",
             "decoder_seq_lod_cpu", "encoder_batch_idx_cpu", "decoder_batch_idx_cpu",
             "len_info_cpu",
