...
#ifndef DISPATCH_FLOAT_FP16_DTYPE
#define DISPATCH_FLOAT_FP16_DTYPE(pd_dtype, c_type, ...)                    \
  switch (pd_dtype) {                                                       \
...
#ifndef DISPATCH_FP16_DTYPE
#define DISPATCH_FP16_DTYPE(pd_dtype, c_type, ...)                    \
  switch (pd_dtype) {                                                 \
    case phi::DataType::BFLOAT16: {                                   \
      using c_type = phi::dtype::bfloat16;                            \
      __VA_ARGS__                                                     \
    ...
    default: {                                                        \
      PD_THROW("Only supported attr of input type in [fp16, bf16]."); \
    }                                                                 \
  }
#endif
...
template <typename T, int Size>
HOSTDEVICE inline void Fill(AlignedVector<T, Size> *vec, const T val) {
#pragma unroll
