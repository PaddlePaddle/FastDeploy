...
static inline constexpr auto kFE4M3fn = machete::ScalarType::float_(
    4, 3, true, machete::ScalarType::NAN_EXTD_RANGE_MAX_MIN);
...
static inline constexpr auto kFE5M10 =
    machete::ScalarType::float_IEEE754(5, 10);
