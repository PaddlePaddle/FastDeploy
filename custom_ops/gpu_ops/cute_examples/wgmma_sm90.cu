...
paddle::Tensor CUTEGEMM(const paddle::Tensor &A, const paddle::Tensor &B) {
    ...
    auto A_ptr = (cutlass::half_t*)(A.data<paddle::float16>());
    auto B_ptr = (cutlass::half_t*)(B.data<paddle::float16>());
    ...
    auto C = paddle::empty({m, n}, paddle::DataType::FLOAT16, A.place());
    auto C_ptr = (cutlass::half_t*)(C.data<paddle::float16>());
