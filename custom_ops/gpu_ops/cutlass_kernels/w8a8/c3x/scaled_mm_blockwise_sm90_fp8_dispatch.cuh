...
struct cutlass_3x_gemm_fp8_blockwise_sm90 {
...
void cutlass_gemm_caller_blockwise_sm90(paddle::Tensor &out,
  ...
  PD_CHECK(m % 4 == 0, "m must be divisible by 4 for blockwise SM90 gemm");
...
void cutlass_gemm_blockwise_sm90_fp8_dispatch(paddle::Tensor &out,
  ...
  cutlass_gemm_caller_blockwise_sm90<cutlass_3x_gemm_fp8_blockwise_sm90<
      OutType,
      1,
      128,
      128,
