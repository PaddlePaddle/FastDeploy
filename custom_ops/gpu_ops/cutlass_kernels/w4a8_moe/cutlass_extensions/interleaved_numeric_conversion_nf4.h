...
template <>
struct FastInterleavedAndBiasedNumericArrayConverterNf4<half_t, uint8_t, 4> {
...
template <int N>
struct FastInterleavedAndBiasedNumericArrayConverterNf4<half_t, uint8_t, N> {
...
template <>
struct FastInterleavedAndBiasedNumericArrayConverterNf4<half_t, uint4b_t, 8> {
...
template <int N>
struct FastInterleavedAndBiasedNumericArrayConverterNf4<half_t, uint4b_t, N> {
