...
struct DeviceGemmFp8RowwiseSm89 {
  ...
  using ElementOutput = typename std::conditional_t<
      std::is_same_v<OutElementType, phi::dtype::bfloat16>,
      cutlass::bfloat16_t,
      cutlass::half_t>;
  ...
  using OutputTileThreadMap =
      cutlass::epilogue::threadblock::OutputTileThreadLayout<CtaShape,
                                                             WarpShape,
                                                             ElementOutput,
                                                             AlignmentC,
                                                             EVTEpilogueStages>;
  ...
  using EpilogueBScale =
      cutlass::epilogue::threadblock::Sm80EVT<ComputeBScale, accSrc, bScaleSrc>;

  using ComputeAScale = cutlass::epilogue::threadblock::VisitorCompute<
      cutlass::multiplies,
      ElementComputeEpilogueScale,
      ElementComputeEpilogueScale,
      cutlass::FloatRoundStyle::round_to_nearest>;
  ...
  using EpilogueAScale = cutlass::epilogue::threadblock::
      Sm80EVT<ComputeAScale, EpilogueBScale, aScaleSrc>;
  ...
  using EVTCompute0 =
      cutlass::epilogue::threadblock::Sm80EVT<Compute0, EpilogueAScale, Bias>;
  ...
  using EpilogueStore =
      cutlass::epilogue::threadblock::Sm80EVT<dTar, EVTCompute0>;
