...
template <
    ...
    typename KernelSchedule = cutlass::gemm::
...
bool dispatch_fuse_block_gemm_c3x(GemmEpilogueAllParams params) {
  ...
  static constexpr bool IsStreamK =
      cute::is_same_v<TileSchedule, cutlass::gemm::StreamKScheduler>;
  ...
  auto a_scale_ptr =
      reinterpret_cast<float*>(const_cast<void*>(params.A_scale));
  auto b_ptr = reinterpret_cast<ElementB*>(const_cast<void*>(params.B));
  auto b_scale_ptr =
      reinterpret_cast<float*>(const_cast<void*>(params.B_scale));
