...
template <typename InType,
          typename OutType, 
          typename WeightQuantTraits>
MoeGemmRunner<InType, OutType, WeightQuantTraits>::MoeGemmRunner() {
  int device{-1};
...
void MoeGemmRunner<InType, OutType, WeightQuantTraits>::dispatch_to_arch<EpilogueTag>(
    const InType* A,
    const typename WeightQuantTraits::WeightType* B,
    const OutType* weight_scales,
    const OutType* biases,
...
template <typename InType,
          ...
          typename WeightQuantTraits>
template <typename EpilogueTag>
void MoeGemmRunner<InType, OutType, WeightQuantTraits>::run_gemm<EpilogueTag>(
    const InType* A,
    const typename WeightQuantTraits::WeightType* B,
    const OutType* weight_scales,
    const OutType* biases,
  ...
  //         kernels::cutlass_kernels::get_candidate_configs(sm_, 7, config_type_param);
...
void MoeGemmRunner<InType, OutType, WeightQuantTraits>::moe_gemm_bias_act(
    const InType* A,
    const typename WeightQuantTraits::WeightType* B,
    const OutType* weight_scales,
    const OutType* biases,
...
template <typename InType, typename OutType, typename WeightQuantTraits>
void MoeGemmRunner<InType, OutType, WeightQuantTraits>::moe_gemm(
    const InType* A,
    const typename WeightQuantTraits::WeightType* B,
    const OutType* weight_scales,
    OutType* C,
