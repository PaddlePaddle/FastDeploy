...
//         // if(tid==0)
//         // {
//         //     printf("this is another DEBUG point");
//         //     printf("%d batch_id", batch_id);
//         //     // printf("%d indexer_kv_id", indexer_kv_id);
//         //     // printf("%d head_id", head_id);
//         // }
//         // __syncthreads();
//         // print_tensor<int>(cu_seqlens_q, "cu_seqlens_q");
//         // print_tensor<int>(seq_lens_decoder, "seq_lens_decoder");

//         if (indexer_kv_id >= indexer_top_k || batch_id >= bsz || head_id >= kv_heads) return;
//         if (seq_lens_decoder[batch_id] <= 0) return;
//         if (indexer_kv_id+dim_id >= seq_lens_decoder[batch_id]) return;
...
//     int grid_size = batch * indexer_top_k/2 * kv_heads;//indexer_top_k;
...
//     // printf("grid_size: %d, block_dim: %d\n", grid_size, block_dim.x);
