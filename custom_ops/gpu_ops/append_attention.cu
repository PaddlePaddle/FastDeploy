...
void AppendAttentionKernel(
  ...
  // set_max_lengths: max_len_this_time, max_enc_len_this_time,
  // max_dec_len_this_time, max_enc_dec_len_this_time,
  // max_just_dec_len_this_time, max_just_dec_merged_len_this_time,
