...
#include "append_attn/append_attention_c8_impl.cuh"
...
std::vector<paddle::Tensor> DecodeAppendAttention(
    ...
    const int decode_block_shape_q,
  ...
  bool is_fp8 = cache_quant_type_str == "cache_fp8" or cache_quant_type_str == "block_wise_fp8";
              ...
              {DISPATCH_HEAD_DIM(
                  ...
                  {DISPATCH_BLOCK_SIZE(
                      ...
                      {DISPATCH_BLOCKSHAPE_Q(
                          decode_block_shape_q, BLOCK_SHAPE_Q, NUM_WARP_Q, {
                            DISPATCH_DyCfp8(is_dynamic_cfp8, IsDynamicC8, {
                              DISPATCH_IS_FP8(is_fp8, IsFP8, {
                                switch (qkv.dtype()) {
                                  case paddle::DataType::BFLOAT16: {
                                    MultiQueryAppendC8Attention<paddle::bfloat16,
                                                            GROUP_SIZE,
                                                            HEAD_DIM,
                                                            BLOCK_SIZE,
                                                            CAUSAL,
                                      ...
                                      value_cache,
                                      attn_mask,
                                      cache_quant_type_str == "block_wise_fp8" ? cache_k_quant_scales.get()
                                                                              : cache_k_dequant_scales.get(),
                                      cache_quant_type_str == "block_wise_fp8" ? cache_v_quant_scales.get()
                                  ...
                                  case paddle::DataType::FLOAT16: {
                                    MultiQueryAppendC8Attention<paddle::float16,
                                                            GROUP_SIZE,
                                                            HEAD_DIM,
                                                            BLOCK_SIZE,
                                                            CAUSAL,
