...
#if defined(CUSTOM_GPU) || defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || \
    defined(CUSTOM_METAX) || defined(CUSTOM_CPU)
...
#if defined(CUSTOM_GPU) || defined(CUSTOM_ROCM)
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || defined(CUSTOM_GCU) || \
    defined(CUSTOM_METAX) || defined(CUSTOM_CPU)
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || \
    defined(CUSTOM_METAX) || defined(CUSTOM_CPU)
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || defined(CUSTOM_METAX)
...
#if defined(CUSTOM_GPU) || defined(CUSTOM_ILUVATAR)
...
#if defined(CUSTOM_GPU) || defined(CUSTOM_METAX)
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_METAX)
...
PYBIND11_MODULE(fastdeploy_ops, m) {
    ...
    m.def("set_stop_value_multi_ends",
          &GetStopFlagsMulti,
          "set_stop_value_multi_ends function");
     ...
     */
    m.def(
        "get_padding_offset", &GetPaddingOffset, "get_padding_offset function");
    /**
     * get_padding_offset.cu
     * get_padding_offset
     */
    m.def("set_value_by_flags_and_idx",
          ...
          "set_value_by_flags_and_idx function");
    /**
     * get_padding_offset.cu
     * get_padding_offset
     */
    m.def("rebuild_padding", &RebuildPaddingFunc, "rebuild_padding function");
    /**
     * update_inputs.cu
     * update_inputs
     */
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || defined(CUSTOM_GCU) || \
    defined(CUSTOM_METAX) || defined(CUSTOM_CPU)
    m.def("get_output", &GetOutputStatic, "get_output function");
    m.def("get_output_topk", &GetOutputTopK, "get_output_topk function");
#endif

#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || \
    defined(CUSTOM_METAX) || defined(CUSTOM_CPU)
    m.def("save_output_topk", &SaveOutMmsgTopK, "save_output_topk function");
#endif

#if defined(CUSTOM_ROCM) || defined(CUSTOM_ILUVATAR) || defined(CUSTOM_METAX)
    m.def("step_paddle", &StepPaddle, "step_paddle function");
    m.def("get_token_penalty_multi_scores",
          &TokenPenaltyMultiScores,
          "get_token_penalty_multi_scores function");
#endif
...
#if defined(CUSTOM_ROCM) || defined(CUSTOM_METAX)
    m.def("step_reschedule", &Schedule, "step_reschedule function");
    m.def("get_output_ep", &GetOutputEPStatic, "get_output_ep function");
    m.def("step_system_cache", &StepSystemCache, "step_system_cache function");
    m.def("set_data_ipc", &SetDataIpc, "set_data_ipc function");
    m.def("share_external_data",
          &ShareExternalData,
          "share_external_data function");
#endif

#if defined(CUSTOM_ROCM)
    m.def("unset_data_ipc", &UnsetDataIpc, "unset_data_ipc function");
    m.def("speculate_get_output",
          &SpeculateGetOutputStatic,
          "speculate_get_output function");
    ...
    m.def(
        "draft_model_update", &DraftModelUpdate, "draft_model_update function");
...
#if defined(CUSTOM_ILUVATAR)
    m.def("paged_attn", &PagedAttn, "paged_attn function");
    m.def("prefill_fused_paged_attn",
          &PrefillFusedPagedAttn,
          "prefill_fused_paged_attn function");
    m.def("mixed_fused_paged_attn",
          &MixedFusedPagedAttn,
          "mixed_fused_paged_attn function");
    m.def("w8a16_group_gemm", &GroupGemm, "w8a16_group_gemm function");
#endif

#if defined(CUSTOM_METAX)
    m.def("get_token_penalty_once",
          &TokenPenaltyOnce,
          "get_token_penalty_once function");
    m.def("fused_get_rotary_embedding",
          &GetRoPE,
          "fused_get_rotary_embedding function");
    m.def("read_data_ipc", &ReadDataIpc, "read_data_ipc function");
    m.def("moe_expert_dispatch",
          &MoeExpertDispatch,
          "moe_expert_dispatch function");
    m.def("moe_expert_ffn", &MoeExpertFFN, "moe_expert_ffn function");
    m.def("moe_expert_reduce", &MoeExpertReduce, "moe_expert_reduce function");
    m.def("fused_expert_moe", &FusedExpertMoe, "fused_expert_moe function");
#endif

#if defined(CUSTOM_CPU)
    m.def("rebuild_padding_cpu",
          &RebuildPaddingCPU,
          "rebuild_padding_cpu function");
    m.def("set_value_by_flags_and_idx_cpu",
          &SetValueByFlagsAndIdx,
          "set_value_by_flags_and_idx_cpu function");
    m.def("get_token_penalty_multi_scores_cpu",
          &TokenPenaltyMultiScores,
          "get_token_penalty_multi_scores_cpu function");
    m.def("set_stop_value_multi_ends_cpu",
          &GetStopFlagsMulti,
          "set_stop_value_multi_ends_cpu function");
    m.def("update_inputs_cpu", &UpdateInputs, "update_inputs_cpu function");
    m.def("get_padding_offset_cpu",
          &GetPaddingOffset,
          "get_padding_offset_cpu function");
#endif
}
