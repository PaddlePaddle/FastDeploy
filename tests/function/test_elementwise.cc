...
std::tuple<std::vector<float>, std::vector<float> > CreateSameDimeData() {
  ...
  std::vector<float> x_data = { 0.8428625,  0.6461913,  0.13740455, 0.11430702,
                                ...
                                0.21228176, 0.29970083, 0.8621713,  0.40894133,
                                0.12684688, 0.1566195,  0.42884097, 0.8476526,
                                0.2458633,  0.669046,   0.87888306, 0.6762589,
                                0.666453,   0.32523027, 0.4139388,  0.8341406 };
  // Shape: [2, 3, 4]
  std::vector<float> y_data = { 0.8345295,  0.551608,   0.77101785, 0.386742,
                                0.12658621, 0.41240612, 0.20051356, 0.68455917,
                                0.37947154, 0.2953741,  0.97703844, 0.2931625,
                                0.2344262,  0.5054064,  0.40617892, 0.16315177,
                                0.71458364, 0.3748885,  0.65257984, 0.83870554,
                                0.55464447, 0.38836837, 0.472637,   0.5546991 };
...
TEST(fastdeploy, check_same_dim) {
  ...
  std::vector<float> mul_result = {
    0.70339364,  0.3564443,   0.105941355, 0.044207327, 0.083537534, 0.2209738,
    0.14896478,  0.5788666,   0.08055489,  0.08852386,  0.8423745,   0.11988626,
    0.029736232, 0.079156496, 0.17418616,  0.13829602,  0.17568989,  0.25081766,
    0.57354134,  0.5671821,   0.36964446,  0.12630916,  0.19564278,  0.46269706
  };
  Multiply(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
...
TEST(fastdeploy, check_broadcast_dim1) {
  ...
  // Test Add functions
  std::vector<float> add_result = { 1.816614, 1.619943, 1.111156, 1.088058,
                                    1.633677, 1.509567, 1.716668, 1.819356,
                                    1.186033, 1.273452, 1.835923, 1.382693,
                                    0.244174, 0.273947, 0.546168, 0.96498,
                                    0.36319,  0.786373, 0.99621,  0.793586,
                                    0.78378,  0.442557, 0.531266, 0.951468 };
  ...
  // Test subtract
  std::vector<float> sub_result = { -0.130889, -0.32756,  -0.836347, -0.859444,
                                    -0.313825, -0.437935, -0.230835, -0.128146,
                                    -0.76147,  -0.674051, -0.11158,  -0.56481,
                                    0.00952,   0.039292,  0.311514,  0.730326,
                                    0.128536,  0.551719,  0.761556,  0.558932,
                                    0.549126,  0.207903,  0.296612,  0.716814 };
  Subtract(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), sub_result.data(),
             sub_result.size());
  ...
  // Test multiply
  std::vector<float> mul_result = { 0.820738, 0.62923,  0.133798, 0.111307,
                                    0.642604, 0.521752, 0.723416, 0.823409,
                                    0.20671,  0.291834, 0.83954,  0.398207,
                                    0.014883, 0.018376, 0.050315, 0.099453,
                                    0.028846, 0.078497, 0.103117, 0.079343,
                                    0.078193, 0.038158, 0.048566, 0.097867 };
  Multiply(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), mul_result.data(),
             mul_result.size());
  ...
  // Test divide
  std::vector<float> div_result = { 0.865583, 0.66361,  0.141108, 0.117388,
                                    0.677715, 0.55026,  0.762942, 0.868399,
                                    0.218004, 0.30778,  0.885412, 0.419965,
                                    1.081139, 1.334897, 3.65509,  7.224699,
                                    2.095538, 5.702402, 7.490881, 5.763879,
                                    5.680301, 2.771997, 3.528076, 7.109533 };
  Divide(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), div_result.data(),
             div_result.size());
...
TEST(fastdeploy, check_broadcast_dim2) {
  ...
  // Test Add functions
  std::vector<float> add_result = { 1.150895, 0.954224, 0.445437, 0.42234,
                                    1.071647, 0.947537, 1.154637, 1.257326,
                                    0.771139, 0.858558, 1.421029, 0.967799,
                                    0.43488,  0.464652, 0.736874, 1.155685,
                                    0.657584, 1.080767, 1.290604, 1.08798,
                                    1.22531,  0.884088, 0.972796, 1.392998 };
  ...
  // Test subtract
  std::vector<float> sub_result = { 0.53483,   0.338159,  -0.170628, -0.193726,
                                    0.248205,  0.124095,  0.331196,  0.433884,
                                    -0.346576, -0.259156, 0.303314,  -0.149916,
                                    -0.181186, -0.151413, 0.120808,  0.53962,
                                    -0.165857, 0.257325,  0.467162,  0.264538,
                                    0.107596,  -0.233627, -0.144919, 0.275283 };
  Subtract(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), sub_result.data(),
             sub_result.size());
  ...
  check_data(reinterpret_cast<const float *>(z.Data()), sub_result.data(),
             sub_result.size());
  // Test multiply
  std::vector<float> mul_result = { 0.259629, 0.199048, 0.042325, 0.03521,
                                    0.271705, 0.220607, 0.305874, 0.348153,
                                    0.118635, 0.16749,  0.481831, 0.22854,
                                    0.039073, 0.048244, 0.132097, 0.261105,
                                    0.101227, 0.27546,  0.361854, 0.27843,
                                    0.372452, 0.181757, 0.231333, 0.466166 };
  Multiply(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), mul_result.data(),
             mul_result.size());
  ...
  // Test divide
  std::vector<float> div_result = { 2.736277, 2.097801, 0.446071, 0.371087,
                                    1.602849, 1.301407, 1.804418, 2.053832,
                                    0.37985,  0.536274, 1.54274,  0.731745,
                                    0.411797, 0.508451, 1.392193, 2.751827,
                                    0.59716,  1.625,    2.134659, 1.642519,
                                    1.192528, 0.581956, 0.740688, 1.492582 };
  Divide(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), div_result.data(),
             div_result.size());
...
TEST(fastdeploy, check_broadcast_dim3) {
  ...
  // Test Add functions
  std::vector<float> add_result = { 1.469393, 1.159034, 1.126526, 0.438472,
                                    1.286457, 1.048658, 1.732038, 1.16977,
                                    0.838813, 0.812543, 1.851293, 0.733107,
                                    0.753378, 0.669462, 1.417963, 1.171818,
                                    0.872394, 1.181888, 1.868005, 1.000424,
                                    1.292984, 0.838073, 1.403061, 1.158306 };
  ...
  // Test subtract
  std::vector<float> sub_result = { 0.216331,  0.133349,  -0.851717, -0.209858,
                                    0.033395,  0.022974,  -0.246206, 0.52144,
                                    -0.414249, -0.213142, -0.126951, 0.084776,
                                    -0.499684, -0.356223, -0.560281, 0.523487,
                                    -0.380668, 0.156204,  -0.110239, 0.352094,
                                    0.039922,  -0.187612, -0.575183, 0.509975 };
  Subtract(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), sub_result.data(),
             sub_result.size());
  ...
  check_data(reinterpret_cast<const float *>(z.Data()), sub_result.data(),
             sub_result.size());
  // Test multiply
  std::vector<float> mul_result = { 0.52808,  0.331394, 0.13591,  0.037054,
                                    0.413464, 0.274789, 0.734835, 0.274116,
                                    0.133001, 0.153699, 0.852793, 0.132565,
                                    0.079474, 0.080321, 0.424176, 0.27478,
                                    0.154041, 0.343115, 0.869322, 0.21922,
                                    0.417554, 0.166792, 0.409436, 0.270399 };
  Multiply(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), mul_result.data(),
             mul_result.size());
  ...
  check_data(reinterpret_cast<const float *>(z.Data()), mul_result.data(),
             mul_result.size());
  // Test divide
  std::vector<float> div_result = { 1.345284, 1.260019, 0.138916, 0.35262,
                                    1.053301, 1.044797, 0.751087, 2.608561,
                                    0.338821, 0.584392, 0.871653, 1.261521,
                                    0.202459, 0.305395, 0.433557, 2.614878,
                                    0.39242,  1.304584, 0.888549, 2.086155,
                                    1.063719, 0.634172, 0.418491, 2.573195 };
  Divide(x, y, &z);
  check_shape(z.shape, { 2, 3, 4 });
  check_data(reinterpret_cast<const float *>(z.Data()), div_result.data(),
             div_result.size());
...
TEST(fastdeploy, mixed_operation) {
  ...
  std::vector<float> result = { 3.238058,  3.004797,  2.278015,  2.881238,
                                1.822084,  2.073209,  1.524921,  2.619779,
                                1.196421,  1.318079,  1.59565,   1.538118,
                                -0.215903, -0.052794, -0.434044, 0.195022,
                                -0.165874, 0.022943,  -0.130613, 0.527984,
                                -0.046946, -0.176592, -0.583538, 0.348473 };
