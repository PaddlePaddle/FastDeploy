...
def setup_and_run_server():
    ...
    if base_path:
        model_path = os.path.join(base_path, "Qwen2.5-VL-7B-Instruct")
    else:
...
def test_consistency_between_runs(api_url, headers, consistent_payload):
    ...
    base_path = os.getenv("MODEL_PATH")
    if base_path:
        base_file = os.path.join(base_path, "Qwen2.5-VL-7B-Instruct-base")
    else:
        base_file = "Qwen2.5-VL-7B-Instruct-base"
