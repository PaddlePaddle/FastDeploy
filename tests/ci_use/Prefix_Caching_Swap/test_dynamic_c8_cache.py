...
os.environ["DG_NVCC_OVERRIDE_CPP_STANDARD"] = "17"
...
def setup_and_run_server():
    ...
    cmd = [
        ...
        "1",
        "--quantization",
        '{"dense_quant_type":"block_wise_fp8","moe_quant_type":"block_wise_fp8","quantization":"mix_quant","kv_cache_quant_type":"block_wise_fp8"}',
        "--swap-space",
        "10",
    ]
