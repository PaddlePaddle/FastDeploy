...
FD_API_PORT = int(os.getenv("FD_API_PORT", 9032))
FD_ENGINE_QUEUE_PORT = int(os.getenv("FD_ENGINE_QUEUE_PORT", 7102))
FD_METRICS_PORT = int(os.getenv("FD_METRICS_PORT", 7203))
...
def setup_and_run_server():
    ...
    if base_path:
        model_path = os.path.join(base_path, "Qwen2.5-7B-Instruct")
    else:
