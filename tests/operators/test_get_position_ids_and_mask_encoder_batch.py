...
class TestGetPositionIds(unittest.TestCase):
    ...
    def test_basic_functionality(self):
        ...
        seq_lens_encoder = paddle.to_tensor([1, 2], dtype="int32")
        seq_lens_decoder = paddle.to_tensor([3, 2], dtype="int32")
        seq_lens_this_time = paddle.to_tensor([1, 2], dtype="int32")

        total_len = int(seq_lens_this_time.numpy().sum())
        ...
        expected_position_ids = np.array([3, 2, 3], dtype=np.int32)
    ...
    def test_empty_decoder(self):
        ...
        seq_lens_this_time = paddle.to_tensor([2], dtype="int32")
