...
class TestSpeculateLimitThinkingContentLengthV1(unittest.TestCase):
    ...
    def test_normal_thinking_phase_no_truncation(self):
        ...
        next_tokens = paddle.to_tensor(
            [[100, 101, 102, 0, 0], [200, 201, 0, 0, 0]], dtype="int64"
        )
    ...
    def test_force_truncation_when_exceeding_limit(self):
        ...
        next_tokens = paddle.to_tensor([[100, 101, 102, 103, 0]], dtype="int64")
        ...
        assert limit_think_status.numpy()[0] == 1  # Status updated to 1
    ...
    def test_model_naturally_generates_think_end_id(self):
        ...
        next_tokens = paddle.to_tensor([[100, 999, 102, 0, 0]], dtype="int64")
    ...
    def test_disabled_feature_negative_max_think_len(self):
        ...
        next_tokens = paddle.to_tensor([[100, 101, 102, 0, 0]], dtype="int64")
    ...
    def test_zero_accept_num_early_return(self):
        ...
        next_tokens = paddle.to_tensor([[100, 101, 0, 0, 0]], dtype="int64")
    ...
    def test_status_transition_from_0_to_1_to_2(self):
        ...
        # Second call: status 1 with think_end_id should transition to status 2
        next_tokens2 = paddle.to_tensor([[999, 0, 0, 0, 0]], dtype="int64")
        step_idx2 = paddle.to_tensor([10], dtype="int64")
        limit_think_status2 = paddle.to_tensor([1], dtype="int32")
        accept_num2 = paddle.to_tensor([1], dtype="int32")
        seq_lens_decoder2 = paddle.to_tensor([10], dtype="int32")
        ...
        assert limit_think_status2.numpy()[0] == 2  # Transitioned to 2
    ...
    def test_mixed_batch_with_different_states(self):
        ...
        tokens_per_step = 4
        next_tokens = paddle.to_tensor(
            [[100, 101, 102, 0], [200, 999, 202, 0], [300, 301, 0, 0]], dtype="int64"
        )
...
class TestSpeculateLimitThinkingContentLengthV2(unittest.TestCase):
    ...
    def test_normal_thinking_phase_no_truncation(self):
        """Test normal thinking phase when all tokens are within limit"""
        next_tokens = paddle.to_tensor([[100, 101, 102, 0, 0], [200, 201, 0, 0, 0]], dtype="int64")
        max_think_lens = paddle.to_tensor([10, 15], dtype="int32")
        step_idx = paddle.to_tensor([5, 8], dtype="int64")
        limit_think_status = paddle.to_tensor([0, 0], dtype="int32")
        accept_num = paddle.to_tensor([3, 2], dtype="int32")
    ...
    def test_injection_sequence_steps(self):
        ...
        next_tokens = paddle.to_tensor([[100, 0, 0, 0, 0]], dtype="int64")
        ...
        next_tokens = paddle.to_tensor([[200, 0, 0, 0, 0]], dtype="int64")
        ...
        next_tokens = paddle.to_tensor([[300, 0, 0, 0, 0]], dtype="int64")
        ...
        next_tokens = paddle.to_tensor([[400, 0, 0, 0, 0]], dtype="int64")
