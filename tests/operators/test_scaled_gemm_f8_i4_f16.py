...
from fastdeploy_debug_ops import static_op_scaled_gemm_f8_i4_f16 as scaled_gemm_f8_i4_f16
from fastdeploy_debug_ops import static_op_scaled_gemm_f8_i4_f16_weight_quantize as scaled_gemm_f8_i4_f16_weight_quantize
...
class Test(unittest.TestCase):
    ...
    def test_bf16(self):
        ...
        """
        M, N, K = 1,8192,8192
        A_fp32 = paddle.ones((M, K)).clip(-448, 448)
        B_fp32 = paddle.ones((K, N)).clip(-448, 448)
        C_fp32 = paddle.matmul(A_fp32, B_fp32)
