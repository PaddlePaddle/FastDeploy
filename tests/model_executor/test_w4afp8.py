...
import paddle
from fastdeploy.model_executor.layers.quantization.w4afp8 import W4AFP8Config, W4AFP8LinearMethod
...
class TestW4AFP8LinearMethod(unittest.TestCase):
    ...
    @patch("fastdeploy.model_executor.layers.quantization.w4afp8.fastdeploy.model_executor.ops.gpu.scaled_gemm_f8_i4_f16_weight_quantize")
    ...
    @patch("fastdeploy.model_executor.layers.quantization.w4afp8.fastdeploy.model_executor.ops.gpu.scaled_gemm_f8_i4_f16")
