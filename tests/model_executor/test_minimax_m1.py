...
"""
Tests for MiniMax-M1 model — architecture dispatch, slope construction, registration,
forward paths, and Lightning Attention correctness via pure-Python/NumPy reference.
