...
from fastdeploy.metrics.trace import FilteringSpanProcessor, lable_span
...
class TestTraceComprehensive:
    ...
    def test_lable_span_functionality(self):
        """Test the lable_span function with different scenarios"""
