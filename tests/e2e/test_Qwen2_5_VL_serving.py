...
def test_consistency_between_runs(api_url, headers, consistent_payload):
    ...
    # base result
    content2 = "这张图片展示了一群人在进行某种活动。前景中有两个孩子和一个成年人，他们似乎在观看或参与某个艺术创作过程。成年人手里拿着一个扇子，上面有各种颜色的颜料，看起来像是在指导孩子们如何使用颜料。孩子们的表情专注而好奇，似乎对这个活动很感兴趣。\n\n背景中还有其他几个人，其中一个人穿着粉色的衣服，背对着镜头。整个场景看起来像是在一个室内环境中，可能是教室或工作室。光线充足，环境整洁明亮。"
