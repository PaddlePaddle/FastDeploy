...
class TestIPCSignal(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        for suffix in [0, 1, 2]:
            try:
                name = f"{self.test_name_base}.{suffix}"
    ...
    def test_create_with_suffix(self):
        ...
        signal = IPCSignal(name=name, array=array, dtype=np.int32, suffix=suffix, create=True)
    ...
    def test_attach_to_existing(self):
        ...
        signal1 = IPCSignal(name=name, array=array, dtype=np.int64, create=True)
    ...
    def test_create_with_shm_size(self):
        ...
        signal = IPCSignal(name=name, shm_size=1024, create=True)
    ...
    def test_attach_with_shm_size(self):
        ...
        # Create
        signal1 = IPCSignal(name=name, shm_size=512, create=True)
    ...
    def test_multiple_array_creation_replaces_existing(self):
        ...
        signal2 = IPCSignal(name=name, array=array2, dtype=np.int32, create=True)
...
class TestIPCSignalEdgeCases(unittest.TestCase):
    ...
    def test_empty_array_raises_error(self):
        """Test IPCSignal with empty array - should raise ValueError."""
        # Empty arrays have nbytes=0 which is not allowed by SharedMemory
