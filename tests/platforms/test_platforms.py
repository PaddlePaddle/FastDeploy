...
class TestMACAPlatform(unittest.TestCase):
    ...
    def test_get_attention_backend_mla(self):
        """Verify MLA_ATTN returns correct backend class"""
        self.assertIn("MetaxMLAAttentionBackend", MACAPlatform.get_attention_backend_cls(_Backend.MLA_ATTN))
