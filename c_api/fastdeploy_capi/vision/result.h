...
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_ClassifyResultWrapper* FD_C_CreateClassifyResultWrapper();
...
FASTDEPLOY_CAPI_EXPORT extern void FD_C_DestroyClassifyResultWrapper(__fd_take FD_C_ClassifyResultWrapper* fd_c_classify_result_wrapper);
...
FASTDEPLOY_CAPI_EXPORT extern void FD_C_DestroyClassifyResult(__fd_take FD_C_ClassifyResult* fd_c_classify_result);
 ...
 */
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_ClassifyResult* FD_C_ClassifyResultWrapperGetData(__fd_keep FD_C_ClassifyResultWrapper* fd_c_classify_result_wrapper);
...
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_ClassifyResultWrapper* FD_C_CreateClassifyResultWrapperFromData(__fd_keep FD_C_ClassifyResult* fd_c_classify_result);
...
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_DetectionResultWrapper* FD_C_CreateDetectionResultWrapper();
...
FASTDEPLOY_CAPI_EXPORT extern void FD_C_DestroyDetectionResultWrapper(__fd_take FD_C_DetectionResultWrapper* fd_c_detection_result_wrapper);
...
FASTDEPLOY_CAPI_EXPORT extern void FD_C_DestroyDetectionResult(__fd_take FD_C_DetectionResult* fd_c_detection_result);
 ...
 */
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_DetectionResult* FD_C_DetectionResultWrapperGetData(__fd_keep FD_C_DetectionResultWrapper* fd_c_detection_result_wrapper);
...
FASTDEPLOY_CAPI_EXPORT extern __fd_give FD_C_DetectionResultWrapper* FD_C_CreateDetectionResultWrapperFromData(__fd_keep FD_C_DetectionResult* fd_c_detection_result);
