...
void FD_RuntimeOptionSetModelBuffer(
    ...
    size_t model_buffer_size, const char *params_buffer,
    size_t params_buffer_size, const FD_ModelFormat format) {
  CHECK_AND_CONVERT_FD_RuntimeOption;
  runtime_option->SetModelBuffer(model_buffer, model_buffer_size, params_buffer,
                                 params_buffer_size,
                                 static_cast<fastdeploy::ModelFormat>(format));
}
